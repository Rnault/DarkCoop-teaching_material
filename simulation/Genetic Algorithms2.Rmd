...
Sep <- function(company){
  ...
  Run <- CoopCor_simple(n_game = 1, tmax = 100, company[1], company[2], company[3], lose.game.chance = 0.2)
...
SIMULATIONS
```{r}
test <- EvoLight(100, 50, "leader", lose.game.percent = 0.03)

everyone_0.2_t40 <- EvoLight(100, 250, "everyone", lose.game.percent = 0.02)
